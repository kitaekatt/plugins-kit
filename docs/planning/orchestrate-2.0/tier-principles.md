...
Vocabulary is defined in [lexicon.md](lexicon.md); every criterion here is stated
in those terms.
...
### P1.3 -- The MCP / harness-tools gate was REMOVED (2026-08-07)
...
### P3.5 -- Section 0 applies on this ladder too
...
only the first kind earns rendered tokens. Tagged today: P0.3, P0.4, P3.6.
