"""Tests for pdf-kit's custom bootstrap script message routing.
...
class TestChromiumCachedRouting:
    def test_plugin_root_is_relative_to_moved_script(self):
        assert custom_bootstrap.PLUGIN_ROOT == _SCRIPT.resolve().parent
