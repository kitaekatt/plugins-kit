// md-domain audit_project_doc lane — REMEDIATE workflow (after-Q&A phase).
//
...
// generate_skill lane by the main loop, not performed blind in a lane.
//
...
export const meta = {
  name: 'md-domain-project-doc-remediate',
