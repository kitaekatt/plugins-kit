...
claude_md:
  ...
  insights:
    ...
    - id: new_lane_records_extend_the_registry_test
      ...
      detail: |
        Preserve every invariant the registry test enforces: the scalar subject
        axis, the three-phrasing minimum, a non-empty change driver, and bound
        path resolution. Add each lane to the verb-specific roster that applies.
      origin: Registry-test generalization, 2026-09-06.
      added: "2026-09-06"
    ...
    - id: tree_scale_generation_has_a_lane
      keywords: [tree-scale generation, fan-out machinery, single-document generation, generation lane, workflow lane]
