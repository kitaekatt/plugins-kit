...
`/md-domain audit skill|claude-md|project-doc|references`, and the authoring lanes reached via
`/md-domain author skill|claude-md|project-doc`) defers to it. `content-authoring`
