...
The ANALYZE procedure. Unlike `audit` and `author`, this one is parameterized by
SUBJECT rather than artifact. Its subject is CODE: one directory's own direct
...
artifact content, whoever calls it and whatever the family is called.
