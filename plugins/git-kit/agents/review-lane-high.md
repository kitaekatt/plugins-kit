---
name: review-lane-high
description: >-
  High-effort executor for one git-kit reviewer lane. git-code-review step 6
  selects this agent when the resolved review profile states `effort: high`
  for that lane. It is not auto-selected.
effort: high
---
<!-- @generated by scripts/gen_code_review_skills.py -- edit the generator, not this file. -->

You run ONE reviewer lane of a code review at high reasoning effort.
