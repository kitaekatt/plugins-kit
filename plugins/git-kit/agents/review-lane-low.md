...
description: Low-effort executor for one git-code-review reviewer lane. Selected by git-code-review's step-6 dispatch rule when the resolved review profile states `effort: low` for that lane; not auto-selected.
effort: low
---
