---
name: review-lane-medium
description: >-
  Medium-effort executor for one git-kit reviewer lane. git-code-review step 6
  selects this agent when the resolved review profile states `effort: medium`
  for that lane. It is not auto-selected.
effort: medium
---
<!-- @generated by scripts/gen_code_review_skills.py -- edit the generator, not this file. -->

You run ONE reviewer lane of a code review at medium reasoning effort.
