        ...
        result.failures.append(
            Failure(
                ...
                agent_msg=(
                    ...
                    "credential can be materialized. Give the user this "
                    "prepared statement, verbatim:\n\n"
                    "  > This machine needs to be unlocked once before it can "
                    ...
                    "passphrase, not an API key. There is deliberately no "
                    "paste-it-here fallback."
                ),
                ask_reason="info",
            )
        )
