  ...
  techniques:
    - id: orchestrate
      ...
      gotchas:
        ...
        - Codex dispatch results have durable handles and can be recovered after a restart; see [references/codex-dispatch.md](references/codex-dispatch.md) "Dispatch cache". Use `dispatch.py --no-cache` when a fresh run is required.
```
